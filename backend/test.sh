...
curl http://localhost:5000/api/addBR -H "Content-Type: application/json" -d '{"BloodType": "A", "Location": "unsw", "ProdDate": "2019-11-01", "ExpDate": "2020-01-04", "IsOkay": "True"}'
curl http://localhost:5000/api/addBR -H "Content-Type: application/json" -d '{"BloodType": "A", "Location": "unsw", "ProdDate": "2019-11-01", "ExpDate": "2020-01-03", "IsOkay": "True"}'
curl http://localhost:5000/api/addBR -H "Content-Type: application/json" -d '{"BloodType": "A", "Location": "unsw", "ProdDate": "2019-11-01", "ExpDate": "2020-01-02", "IsOkay": "True"}'
